...
void app_main(void)
{
    ...
    xTaskCreate(&bme280_task, "bme280_task", 2*APP_MINIMAL_STACK_SIZE, NULL, MED_PRIORITY, NULL);
    xTaskCreate(&victron_ble_task, "victron_ble_task", 6*APP_MINIMAL_STACK_SIZE, NULL, MED_PRIORITY, NULL);
    xTaskCreate(&custom_metrics_task, "metrics_task", 2*APP_MINIMAL_STACK_SIZE, NULL, MED_PRIORITY, NULL);
